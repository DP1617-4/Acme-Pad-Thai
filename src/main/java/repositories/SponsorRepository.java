...
public interface SponsorRepository extends JpaRepository<Sponsor, Integer> {
	...
	Collection<Double> calculateMinAvgMaxFromCampaignsOfSponsors();
	...
	Collection<Double> calculateMinAvgMaxFromCampaignsOfSponsorsByDate();
	...
	Sponsor findInnactiveSponsorInThreeMonths();
